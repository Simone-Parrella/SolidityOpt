...
public interface SolidityVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#tryCatchStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTryCatchStatement(SolidityParser.TryCatchStatementContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#listaCatch}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitListaCatch(SolidityParser.ListaCatchContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#catchBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCatchBlock(SolidityParser.CatchBlockContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SolidityParser#listaSalt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitListaSalt(SolidityParser.ListaSaltContext ctx);
	/**
