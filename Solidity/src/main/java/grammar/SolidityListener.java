...
public interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#catchBlock}.
	 * @param ctx the parse tree
	 */
	void enterCatchBlock(SolidityParser.CatchBlockContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#catchBlock}.
	 * @param ctx the parse tree
	 */
	void exitCatchBlock(SolidityParser.CatchBlockContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SolidityParser#listaSalt}.
	 * @param ctx the parse tree
	 */
	void enterListaSalt(SolidityParser.ListaSaltContext ctx);
	/**
	 * Exit a parse tree produced by {@link SolidityParser#listaSalt}.
	 * @param ctx the parse tree
	 */
	void exitListaSalt(SolidityParser.ListaSaltContext ctx);
	/**
